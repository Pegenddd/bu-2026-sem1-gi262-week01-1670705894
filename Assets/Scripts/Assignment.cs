...
public class Assignment : MonoBehaviour
{
        ...
        else if (as08Quantity > 0)
        {
            if (as08Payment >= as08Price)
            {
                ...
                if (as08Payment > as08Price)
                {
                    ...
                    Debug.Log("Your chance " + change + " THB");
                }
            }
    ...
    {
        if (as09UserChoice < 0 || as09UserChoice > 2 || as09ComputerChoice < 0 || as09ComputerChoice > 2) 
        {
            Debug.Log("Invalid Number Selection");
        }
        ...
        else if ((as09UserChoice == 0 && as09ComputerChoice == 2) || (as09UserChoice == 1 && as09ComputerChoice == 2) || (as09UserChoice == 2 && as09ComputerChoice == 1))
        {
            Debug.Log("You Wins");
        }
        else
